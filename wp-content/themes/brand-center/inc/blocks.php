...
function abc_render_sibling_nav_buttons() {
    ...
    ?>
    <nav class="sibling-nav" aria-label="<?php esc_attr_e( 'Page navigation', 'brand-center' ); ?>">
        <?php if ( $prev ) : ?>
        <a href="<?php echo esc_url( $prev['url'] ); ?>" class="sibling-nav-btn sibling-nav-prev">
            <?php abc_icon( 'chevron-left-20' ); ?>
            <span class="sibling-nav-text"><?php esc_html_e( 'Previous page', 'brand-center' ); ?></span>
        </a>
        <?php endif; ?>
        <?php if ( $next ) : ?>
        <a href="<?php echo esc_url( $next['url'] ); ?>" class="sibling-nav-btn sibling-nav-next">
            <span class="sibling-nav-text"><?php esc_html_e( 'Next page', 'brand-center' ); ?></span>
