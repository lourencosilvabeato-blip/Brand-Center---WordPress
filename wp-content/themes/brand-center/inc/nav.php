<?php
/**
 * Navigation helper functions — Brand Center
 *
...
function abc_get_breadcrumb_items() {
    ...
    $breadcrumb = array(
        array( 'label' => __( 'Home', 'brand-center' ), 'url' => abc_homepage_url() ),
    );
...
function abc_get_profile_dropdown_items() {
    ...
    if ( in_array( 'local_admin', $roles, true ) ) {
        $items[] = array(
            'label' => __( 'Invite new user', 'brand-center' ),
    ...
    if ( in_array( 'administrator', $roles, true ) ) {
        $items[] = array(
            'label' => __( 'Go to management panel', 'brand-center' ),
            'url'   => admin_url(),
            'icon'  => 'settings',
        );
    }
    ...
    if ( in_array( 'external_user', $roles, true ) ) {
        $items[] = array(
            'label' => __( 'Change Password', 'brand-center' ),
...
function abc_render_left_sidebar() {
    ...
    ?>
    <aside class="left-sidebar" aria-label="<?php esc_attr_e( 'Section navigation', 'brand-center' ); ?>">
        ...
        <form
            ...
            aria-label="<?php esc_attr_e( 'Search site', 'brand-center' ); ?>"
        >
            ...
            <input
                ...
                placeholder="<?php esc_attr_e( 'Search', 'brand-center' ); ?>"
            ...
            <button
                ...
                aria-label="<?php esc_attr_e( 'Submit search', 'brand-center' ); ?>"
            >
                <?php abc_icon( 'search' ); ?>
            </button>
        </form>
        ...
        <!-- Sibling pages -->
        <?php if ( ! empty( $items ) ) : ?>
        <nav class="left-sidebar-nav" aria-label="<?php esc_attr_e( 'Pages in this section', 'brand-center' ); ?>">
        ...
        <nav class="left-sidebar-utility" aria-label="<?php esc_attr_e( 'Resources', 'brand-center' ); ?>">
            <ul class="left-sidebar-list" role="list">
                <?php if ( $nav_tips_url ) : ?>
                <li class="left-sidebar-item">
                    <a href="<?php echo esc_url( $nav_tips_url ); ?>" class="left-sidebar-link">
                        <?php esc_html_e( 'Navigation Tips', 'brand-center' ); ?>
                    </a>
                </li>
                <?php endif; ?>
                <?php if ( $faqs_url ) : ?>
                <li class="left-sidebar-item">
                    <a href="<?php echo esc_url( $faqs_url ); ?>" class="left-sidebar-link">
                        <?php esc_html_e( 'FAQs', 'brand-center' ); ?>
                    </a>
                </li>
                <?php endif; ?>
            </ul>
...
function abc_render_anchor_bar() {
    ...
    ?>
    <nav class="anchor-bar" aria-label="<?php esc_attr_e( 'On this page', 'brand-center' ); ?>">
...
function abc_render_breadcrumb() {
    ...
    ?>
    <nav class="breadcrumb" aria-label="<?php esc_attr_e( 'Breadcrumb', 'brand-center' ); ?>">
