...
$pw_error_messages = array(
    'required' => __( 'Both password fields are required.', 'brand-center' ),
    'mismatch' => __( 'Passwords do not match. Please try again.', 'brand-center' ),
    'weak'     => __( 'Password does not meet the requirements. Please try again.', 'brand-center' ),
...
<div class="set-password-page">
    ...
    <aside class="set-password-sidebar" aria-label="<?php esc_attr_e( 'Set password', 'brand-center' ); ?>">
            ...
            >
                ...
                <div class="set-password-fields">
                    <p class="set-password-form-label">
                        <?php esc_html_e( 'Define your password', 'brand-center' ); ?>
                    </p>
                    ...
                    <div class="set-password-field">
                        ...
                        <input
                            ...
                            placeholder="<?php esc_attr_e( 'Enter new password', 'brand-center' ); ?>"
                    ...
                    <div class="set-password-field">
                        ...
                        <input
                            ...
                            placeholder="<?php esc_attr_e( 'Confirm new password', 'brand-center' ); ?>"
                            autocomplete="new-password"
                        >
                    </div>
                </div>
                ...
                <button type="submit" class="set-password-btn">
                    <?php esc_html_e( 'Confirm', 'brand-center' ); ?>
                </button>
