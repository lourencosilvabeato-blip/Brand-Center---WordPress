...
<div class="set-password-page">
    ...
    <aside class="set-password-sidebar" aria-label="<?php esc_attr_e( 'Password Recovery', 'ascendum-brand-center' ); ?>">
        ...
        <div class="set-password-sidebar-content">
            ...
            <div class="set-password-expired">
                <p class="set-password-form-label">
                    <?php esc_html_e( 'E-mail sent!', 'ascendum-brand-center' ); ?>
                </p>
                <p class="set-password-expired-body">
                    <?php esc_html_e( 'If an account exists for this email, you will receive password reset instructions shortly. Please check your spam folder.', 'ascendum-brand-center' ); ?>
                </p>
