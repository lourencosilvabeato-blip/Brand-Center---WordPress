<?php
/**
 * Email functions — Ascendum Brand Center
 *
...
function abc_send_invite_email( $to_email, $token ) {
    ...
    $subject = sprintf(
        ...
        __( "You've been invited to %s", 'ascendum-brand-center' ),
        $site_name
    );
...
function abc_send_recovery_email( $to_email, $token ) {
    ...
    $subject = sprintf(
        /* translators: %s: site name */
        __( '[%s] Password reset request', 'ascendum-brand-center' ),
        $site_name
    );
...
function abc_send_admin_reset_email( $to_email, $token ) {
    ...
    $subject = sprintf(
        /* translators: %s: site name */
        __( '[%s] Your password has been reset by an administrator', 'ascendum-brand-center' ),
        $site_name
    );
