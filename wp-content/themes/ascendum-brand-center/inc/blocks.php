...
function abc_buttons_repeater_field( string $key_prefix ): array {
    return array(
        ...
        'sub_fields'   => array(
            ...
            array(
                'key'           => 'field_' . $key_prefix . '_btn_type',
                'label'         => 'Link type',
                'name'          => 'button_type',
                'type'          => 'radio',
                'required'      => 1,
            ...
            array(
                ...
                'conditional_logic' => array(
                    array(
                        array(
                            'field'    => 'field_' . $key_prefix . '_btn_type',
                            'operator' => '==',
                            'value'    => 'url',
                        ),
                    ),
            ...
            array(
                ...
                'sub_fields'   => array(
                    ...
                    array(
                        ...
                        'required'     => 0,
                        'layout'       => 'block',
                        'instructions' => 'Optional. Rendered as an icon: arrow icon for URL, download icon for file.',
                        'sub_fields'   => array(
                            array(
                                'key'           => 'field_gc_btn_type',
                                'label'         => 'Link type',
                                'name'          => 'btn_type',
                                'type'          => 'radio',
                                'required'      => 0,
