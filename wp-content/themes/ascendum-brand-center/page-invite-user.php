...
<main class="invite-page">
    <div class="invite-container">
        ...
        <section class="invite-form-section">
            <h1 class="invite-title"><?php esc_html_e( 'Invite new user', 'ascendum-brand-center' ); ?></h1>
            <p class="invite-intro"><?php esc_html_e( 'Enter the email address of the person you want to invite. They will receive an email with a link to set their password.', 'ascendum-brand-center' ); ?></p>

            <?php if ( $invite_success ) : ?>
            <div class="invite-notice invite-notice--success" role="status">
                <?php esc_html_e( 'Invitation sent successfully.', 'ascendum-brand-center' ); ?>
            </div>
            <?php endif; ?>

            <?php if ( $cancelled ) : ?>
            <div class="invite-notice invite-notice--success" role="status">
                <?php esc_html_e( 'Invitation cancelled.', 'ascendum-brand-center' ); ?>
            </div>
            <?php endif; ?>
            ...
            >
                ...
                <div class="invite-field-group">
                    <label class="invite-label" for="invite-email">
                        <?php esc_html_e( 'New user e-mail', 'ascendum-brand-center' ); ?>
                    </label>
                    ...
                    <input
                        ...
                        placeholder="<?php esc_attr_e( 'name@company.com', 'ascendum-brand-center' ); ?>"
                        autocomplete="email"
                        spellcheck="false"
                    >
                </div>
                ...
                <button type="submit" class="invite-btn">
                    <?php esc_html_e( 'Send invite', 'ascendum-brand-center' ); ?>
                </button>
            </form>
        </section>
        ...
        <section class="invite-pending">
            <h2 class="invite-pending-title">
                ...
                printf(
                    ...
                    esc_html__( 'Pending invites (%d)', 'ascendum-brand-center' ),
                    count( $pending_users )
                );
                ?>
            </h2>
                ...
                <li class="invite-pending-item">
                    ...
                    >
                        ...
                        <button type="submit" class="invite-cancel-btn">
                            ...
                            <?php esc_html_e( 'Cancel invite', 'ascendum-brand-center' ); ?>
                        </button>
                    </form>
                </li>
                <?php endforeach; ?>
