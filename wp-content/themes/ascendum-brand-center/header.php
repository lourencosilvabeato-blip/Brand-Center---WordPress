...
<header id="site-header" class="site-header" role="banner">
    <div class="site-header-inner">
        ...
        <nav class="site-nav" aria-label="<?php esc_attr_e( 'Main navigation', 'ascendum-brand-center' ); ?>">
...
<header class="mobile-header" role="banner">
    ...
    <button
        ...
        aria-label="<?php esc_attr_e( 'Open navigation menu', 'ascendum-brand-center' ); ?>"
    >
        <?php abc_icon( 'menu' ); ?>
    </button>
...
<div
    ...
    role="dialog"
    aria-modal="true"
    aria-label="<?php esc_attr_e( 'Navigation menu', 'ascendum-brand-center' ); ?>"
>
    ...
    <div class="mobile-menu-l1" data-mobile-screen="l1">
        ...
        <div class="mobile-menu-header">
            ...
            <button
                ...
                aria-label="<?php esc_attr_e( 'Close navigation menu', 'ascendum-brand-center' ); ?>"
            >
                <?php abc_icon( 'close' ); ?>
                <span><?php esc_html_e( 'Close', 'ascendum-brand-center' ); ?></span>
            </button>
        </div>
        ...
        <div class="mobile-menu-content">
            ...
            <div class="mobile-menu-actions">
                ...
                <a href="<?php echo esc_url( abc_get_logout_url() ); ?>" class="mobile-menu-action">
                    <?php abc_icon( 'logout' ); ?>
                    <?php esc_html_e( 'Logout', 'ascendum-brand-center' ); ?>
                </a>
            </div>
        </div>
