...
<main id="main-content" class="homepage">
    ...
    <section
        ...
        <?php endif; ?>
        aria-label="<?php esc_attr_e( 'Hero', 'ascendum-brand-center' ); ?>"
    >
        ...
        <div class="hp-search-wrap">
            <form
                ...
                role="search"
                aria-label="<?php esc_attr_e( 'Search brand center', 'ascendum-brand-center' ); ?>"
                novalidate
            >
                <!-- Bar: filter + input -->
                <div class="hp-search-bar">
                    ...
                    <div class="hp-search-filter-wrap">
                        <label class="screen-reader-text" for="hp-search-filter">
                            <?php esc_html_e( 'Filter by', 'ascendum-brand-center' ); ?>
                        </label>
                        <select
                            id="hp-search-filter"
                            name="abc_filter"
                        ...
                        >
                            <option value=""><?php esc_html_e( 'All content', 'ascendum-brand-center' ); ?></option>
                    ...
                    <div class="hp-search-input-wrap">
                        ...
                        <input
                            ...
                            placeholder="<?php esc_attr_e( 'Search all you need...', 'ascendum-brand-center' ); ?>"
                            autocomplete="off"
                ...
                <p
                    ...
                    role="alert"
                >
                    <?php esc_html_e( 'Please enter a search term before searching.', 'ascendum-brand-center' ); ?>
                </p>
            </form>
        </div><!-- /.hp-search-wrap -->
    ...
    <!-- =====================================================================
         ...
         ===================================================================== -->
    <section class="hp-section hp-help-section" aria-label="<?php esc_attr_e( 'Quick links', 'ascendum-brand-center' ); ?>">
        <div class="hp-section-inner">
