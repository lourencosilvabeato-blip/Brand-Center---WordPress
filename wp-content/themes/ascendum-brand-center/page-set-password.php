 ...
 *
 * A02.2 — Invitee activates their account by setting a password.
 * Public page; authenticated by the invite token in the URL.
 * Invalid or expired tokens are redirected to the expired-link page.
 *
...
if ( empty( $token ) ) {
    wp_safe_redirect( home_url( '/expired-link/' ) );
    exit;
}
...
$invite_user_id = (int) $token_users[0];
$expires        = (int) get_user_meta( $invite_user_id, 'abc_invite_expires', true );
...
<div class="set-password-page">
    ...
    <aside class="set-password-sidebar" aria-label="<?php esc_attr_e( 'Set password', 'ascendum-brand-center' ); ?>">
        ...
        <div class="set-password-sidebar-content">
            ...
            >
                ...
                <?php wp_nonce_field( 'abc_set_password_' . $token, 'abc_set_password_nonce' ); ?>
                ...
                <div class="set-password-fields">
                    ...
                    <div class="set-password-field">
                        <label class="screen-reader-text" for="sp-password">
                    ...
                    <div class="set-password-field">
                        <label class="screen-reader-text" for="sp-password2">
