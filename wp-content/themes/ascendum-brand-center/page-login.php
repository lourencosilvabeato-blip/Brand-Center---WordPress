...
$error_messages = array(
    ...
    'invalid_credentials' => __( 'Invalid credentials. Please check your email and password and try again.', 'ascendum-brand-center' ),
...
<div class="login-page">
    ...
    <aside class="login-sidebar" aria-label="<?php esc_attr_e( 'Login', 'ascendum-brand-center' ); ?>">
        ...
        <div class="login-sidebar-content">
                ...
                <div class="login-form-fields">
                    ...
                    <div class="login-field">
                        <label class="screen-reader-text" for="login-email">
                            <?php esc_html_e( 'Email address', 'ascendum-brand-center' ); ?>
                        </label>
                        <input
                            type="email"
                            id="login-email"
                            ...
                            placeholder="<?php esc_attr_e( 'E-mail', 'ascendum-brand-center' ); ?>"
                            autocomplete="email"
                            spellcheck="false"
                        >
                    </div>
                    ...
                    <div class="login-field">
                        <label class="screen-reader-text" for="login-password">
                            <?php esc_html_e( 'Password', 'ascendum-brand-center' ); ?>
                        </label>
                        <input
                            type="password"
                            id="login-password"
                            ...
                            placeholder="<?php esc_attr_e( 'Password', 'ascendum-brand-center' ); ?>"
                ...
                <div class="login-options">
                    <label class="login-remember-label">
                        ...
                        <span class="login-remember-text">
                            <?php esc_html_e( 'Remember me', 'ascendum-brand-center' ); ?>
                        </span>
                    </label>
                    <a
                    ...
                    >
                        <?php esc_html_e( 'Forgot password?', 'ascendum-brand-center' ); ?>
                    </a>
                </div>

                <!-- Submit -->
                <button type="submit" class="login-btn login-btn--enter">
                    <?php esc_html_e( 'Enter', 'ascendum-brand-center' ); ?>
                </button>
            ...
            <div class="login-sso-divider" aria-hidden="true">
                <span class="login-sso-divider-text">
                    <?php esc_html_e( 'Team member? Please, login here:', 'ascendum-brand-center' ); ?>
                </span>
            </div>
            ...
            <button
                ...
                disabled
                aria-disabled="true"
                title="<?php esc_attr_e( 'SSO not yet configured.', 'ascendum-brand-center' ); ?>"
            >
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                    <path d="M0 0H9.5V9.5H0z" fill="#f25022"/>
                    <path d="M10.5 0H20V9.5H10.5z" fill="#7fba00"/>
