...
$cp_error_messages = array(
    ...
    'wrong_current' => __( 'The current password you entered is incorrect. Please try again.', 'ascendum-brand-center' ),
    'weak'          => __( 'Password must be at least 8 characters long and include an uppercase letter, a number, and a special character.', 'ascendum-brand-center' ),
    'mismatch'      => __( 'The new passwords do not match. Please ensure both fields are identical.', 'ascendum-brand-center' ),
        ...
        >
            ...
            <div class="change-password-field">
                <label class="change-password-label" for="cp-current">
                    <?php esc_html_e( 'Old password', 'ascendum-brand-center' ); ?>
                </label>
                ...
                <input
                    ...
                    placeholder="<?php esc_attr_e( 'Insert your old password', 'ascendum-brand-center' ); ?>"
            ...
            <div class="change-password-field">
                ...
                <input
                    ...
                    placeholder="<?php esc_attr_e( 'Insert your new password', 'ascendum-brand-center' ); ?>"
            ...
            <div class="change-password-field">
                ...
                <input
                    ...
                    placeholder="<?php esc_attr_e( 'Confirm your new password', 'ascendum-brand-center' ); ?>"
                    autocomplete="new-password"
                >
            </div>
            ...
            <button type="submit" class="change-password-btn">
                <?php esc_html_e( 'Save password', 'ascendum-brand-center' ); ?>
            </button>
