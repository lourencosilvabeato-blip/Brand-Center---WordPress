...
if ( ! class_exists( '\Wpo\Tests\Test_Extensions' ) ) {
	...
	class Test_Extensions {
		...
		public function test_wpo365_premium() {
			return $this->get_test_result_for_extensions( 'wpo365-login-premium/wpo365-login.php', 'WPO365 | SYNC', 41.0 );
		}

		public function test_wpo365_sync_5y() {
			return $this->get_test_result_for_extensions( 'wpo365-sync-5y/wpo365-sync-5y.php', 'WPO365 | SYNC | 5Y', 41.0 );
		}

		public function test_wpo365_intranet_5y() {
			return $this->get_test_result_for_extensions( 'wpo365-intranet-5y/wpo365-intranet-5y.php', 'WPO365 | INTRANET | 5Y', 41.0 );
		}

		public function test_wpo365_integrate() {
			return $this->get_test_result_for_extensions( 'wpo365-integrate/wpo365-integrate.php', 'WPO365 | INTEGRATE', 41.0 );
		}

		public function test_wpo365_pro() {
			return $this->get_test_result_for_extensions( 'wpo365-pro/wpo365-pro.php', 'WPO365 | PROFESSIONAL', 41.0 );
		}

		public function test_wpo365_essentials() {
			return $this->get_test_result_for_extensions( 'wpo365-essentials/wpo365-essentials.php', 'WPO365 | ESSENTIALS', 41.0 );
		}

		public function test_wpo365_customers() {
			return $this->get_test_result_for_extensions( 'wpo365-customers/wpo365-customers.php', 'WPO365 | CUSTOMERS', 41.0 );
		}

		public function test_wpo365_intranet() {
			return $this->get_test_result_for_extensions( 'wpo365-login-intranet/wpo365-login.php', 'WPO365 | INTRANET', 41.0 );
		}

		public function test_wpo365_profile_plus() {
			return $this->get_test_result_for_extensions( 'wpo365-login-plus/wpo365-login.php', 'WPO365 | PROFILE+', 41.0 );
		}

		public function test_wpo365_mail() {
			return $this->get_test_result_for_extensions( 'wpo365-mail/wpo365-mail.php', 'WPO365 | MAIL', 41.0 );
		}

		public function test_wpo365_login_plus() {
			return $this->get_test_result_for_extensions( 'wpo365-login-professional/wpo365-login.php', 'WPO365 | LOGIN+', 41.0 );
		}

		public function test_wpo365_avatar() {
			return $this->get_test_result_for_extensions( 'wpo365-avatar/wpo365-avatar.php', 'WPO365 | AVATAR', 41.0 );
		}

		public function test_wpo365_custom_user_fields() {
			return $this->get_test_result_for_extensions( 'wpo365-custom-fields/wpo365-custom-fields.php', 'WPO365 | CUSTOM USER FIELDS', 41.0 );
		}

		public function test_wpo365_groups() {
			return $this->get_test_result_for_extensions( 'wpo365-groups/wpo365-groups.php', 'WPO365 | GROUPS', 41.0 );
		}

		public function test_wpo365_apps() {
			return $this->get_test_result_for_extensions( 'wpo365-apps/wpo365-apps.php', 'WPO365 | APPS', 41.0 );
		}
		...
		public function test_wpo365_roles_access() {
			return $this->get_test_result_for_extensions( 'wpo365-roles-access/wpo365-roles-access.php', 'WPO365 | ROLES + ACCESS', 41.0 );
		}

		public function test_wpo365_scim() {
			return $this->get_test_result_for_extensions( 'wpo365-scim/wpo365-scim.php', 'WPO365 | SCIM', 41.0 );
		}
